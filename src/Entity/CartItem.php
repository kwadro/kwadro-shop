...
class CartItem
{
    ...
    #[ORM\Column(type: 'string', length: 32, enumType: CartItemStatus::class)]
    ...
    public function getStatus(): CartItemStatus
    {
        return $this->status;
    }

    public function setStatus(CartItemStatus $status): static
    {
        $this->status = $status;
