...
class HeaderSettingCrudController extends AbstractCrudController
{
    public function __construct(
        private TranslatorInterface $translator
    ) {
    }
    public static function getEntityFqcn(): string { return HeaderSetting::class; }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextareaField::new('phones', $this->translator->trans('admin.header.phones', [], 'messages'))
                ->setHelp($this->translator->trans('admin.header.phones_help', [], 'messages')),
        ];
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
         ...
         $linkName = $this->translator->trans('menu.link_headersetting_single', [], 'messages');
         return $crud
            ->setFormThemes([
