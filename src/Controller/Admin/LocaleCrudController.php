...
class LocaleCrudController extends AbstractCrudController
{
    ...
    public static function getEntityFqcn(): string { return Locale::class; }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            ChoiceField::new('is_default')->setChoices(['Yes' => 'Yes', 'No' => 'No']),
            AssociationField::new('headertranslatelocales')->setFormTypeOption('by_reference', false),
    ...
    public function configureCrud(Crud $crud): Crud
    {
         ...
         $linkName = $this->translator->trans('menu.link_locale_single', [], 'messages');
         return $crud
            ->setFormThemes([
